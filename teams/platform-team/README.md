...
## 已合入的 Platform Team 交付

2026-07-07 已从 PR #3 精选合并课程平台静态门户：

```text
teams/platform-team/course-platform/
```

当前定位：

- 静态课程门户 MVP。
- 包含课程首页、模块页、文档中心、部署说明和 Agent 接口说明。
- 适合用作课程内容展示和 Team 5 平台入口原型。

合并时已修正：

- 仓库地址示例。
- 指向仓库外 `项目资料/` 的死链接。
- 文档中引用不存在测试脚本的问题，改为静态预览和人工检查说明。

后续仍需补：

- 自动化链接检查脚本。
- 搜索索引重建脚本。
- 与当前 Next.js MVP 的关系说明。
- 是否部署为 GitHub Pages 的最终路径。
